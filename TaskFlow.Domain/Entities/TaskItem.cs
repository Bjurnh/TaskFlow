...
/// see the comment on Enums/WorkItemStatus.cs for the full reasoning.
///
...
public class TaskItem : AggregateRoot
{
        ...
        Guid createdByUserId)
    {
        ...
        task.AddDomainEvents(new TaskCreatedEvent(task.Id, task.OrganizationId, task.ProjectId, task.Title, task.CreatedAt));
    ...
    public void ChangeStatus(WorkItemStatus newStatus)
    {
        ...
        if (newStatus == WorkItemStatus.Done)
        {
            ...
            AddDomainEvents(new TaskCompletedEvent(Id, OrganizationId, ProjectId, CompletedAt.Value));
        }
        else
        {
            CompletedAt = null;
        ...
        AddDomainEvents(new TaskStatusChangedEvent(Id, OrganizationId, oldStatus, newStatus));
    }
    ...
    public void AssignTo(Guid? userId)
    {
        ...
        AddDomainEvents(new TaskAssignedEvent(Id, OrganizationId, previousAssignee, userId));
    }
